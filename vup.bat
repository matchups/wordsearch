...
for %%i in (askdeletequery asklistforprops askloadquery askrenamequery asksavequery asksharequery deletelist dodeletequery doloadquery dorenamequery dosavequery dosharequery styles thirdparty ) do %command% %%i%from%php %%i%to%php
